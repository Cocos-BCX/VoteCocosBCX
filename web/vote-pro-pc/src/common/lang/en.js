export const langEn = {
    ...
    tabTableContainer: {
        ...
        name: 'Name',
        // blockNum: '已生产区块数'
        blockNum: 'Number of blocks produced'
    },
    interFaceMessage: {
        common: {
            'success': 'Success',
    ...
    tipsMessage: {
        ...
        business: {
            ...
            pleaseImportAccountPrivateKey: 'Please import account private key (owner)',
            pleaseImportAssetPrivateKey: 'Please import the asset private key (active)',
